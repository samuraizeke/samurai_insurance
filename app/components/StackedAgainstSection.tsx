  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col gap-20">
        <div className="relative flex flex-col items-center gap-12 text-center text-[#333333] lg:flex-row lg:items-center lg:justify-between lg:text-left">
          <div className="mx-auto w-full max-w-none space-y-4 text-center sm:max-w-2xl lg:mx-0 lg:max-w-xl lg:translate-y-1 lg:text-left">
            ...
            <p
              className={`${workSans.className} w-full text-lg leading-relaxed text-[#333333]/75 sm:text-xl`}
            >
          ...
          <div className="relative w-full max-w-xl lg:max-w-none lg:flex-1">
            <div className="relative flex w-full items-center gap-3 px-1 sm:gap-5 sm:px-3">
              <button
                type="button"
                onClick={handlePrev}
                className="flex h-10 w-10 items-center justify-center rounded-full bg-[#de5e48] text-2xl text-[#f7f6f3] shadow-[0_4px_12px_rgba(222,94,72,0.25)] transition hover:-translate-y-0.5 hover:shadow-[0_6px_16px_rgba(222,94,72,0.3)] sm:h-12 sm:w-12 sm:text-3xl"
              ...
              <div className="relative mx-auto w-full max-w-[460px] overflow-hidden rounded-[40px] border border-[#333333]/25 bg-[radial-gradient(circle_at_top,_rgba(51,51,51,0.08),_transparent_55%),linear-gradient(140deg,_rgba(223,221,215,0.9),_rgba(239,237,233,0.92) 60%,_rgba(246,245,243,0.92))] px-4 py-6 shadow-[0_40px_80px_rgba(51,51,51,0.15)] sm:max-w-[600px] sm:px-6 sm:py-10">
                <ul
                  ...
                  {OPTIONS.map((option, index) => (
                    ...
                    >
                      <header className="flex flex-col gap-3 sm:gap-5">
                        ...
                        <h3 className="text-2xl font-semibold text-[#333333] sm:text-[42px]">
                          {option.title}
                        </h3>
                      </header>
                      <p
                        className={`${workSans.className} mt-6 text-base leading-relaxed text-[#333333]/85 sm:text-lg`}
                      >
                        {option.summary}
                      </p>
                    </li>
            ...
            <div className="mt-6 flex flex-col items-center gap-3 sm:items-end">
              <span
                className={`${workSans.className} text-xs uppercase tracking-[0.4em] text-[#333333]/70`}
              >
                ...
                {OPTIONS.map((option, index) => {
                  ...
                  return (
                    <button
                      ...
                      className={`h-2 rounded-full transition-all duration-300 ${isActive ? "w-10 bg-[#de5e48]" : "w-3 bg-[#333333]/30 hover:bg-[#333333]/50"}`}
        ...
        <div className="relative overflow-hidden rounded-[40px] border border-[#de5e48]/60 bg-[#eeecea]/90 p-10 shadow-[0_30px_90px_rgba(51,51,51,0.25)]">
          ...
          <div className="relative z-10 flex flex-col items-center gap-10 text-center">
            <div className="max-w-3xl space-y-6">
              ...
              <p
                className={`${workSans.className} text-lg leading-relaxed text-[#333333]/90`}
              >
            ...
            <p
              className={`${workSans.className} text-lg leading-relaxed text-[#333333]/80`}
            >
            ...
            <div className="grid w-full max-w-5xl gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {SAMURAI_BENEFITS.map((benefit) => (
                <div
                  key={benefit.title}
                  className="flex h-full flex-col gap-3 rounded-3xl border border-[#333333]/25 bg-[radial-gradient(circle_at_top,_rgba(51,51,51,0.08),_transparent_55%),linear-gradient(140deg,_rgba(223,221,215,0.9),_rgba(239,237,233,0.92) 60%,_rgba(246,245,243,0.92))] p-6 text-center shadow-[0_20px_60px_rgba(51,51,51,0.2)] sm:text-left"
                >
                  <h4 className="text-xl font-semibold text-[#333333] sm:text-[22px]">
                    {benefit.title}
                  </h4>
                  <p
                    className={`${workSans.className} text-base leading-relaxed text-[#333333]/80`}
                  >
                    {benefit.description}
                  </p>
                </div>
