  ...
  return (
    <section className="rounded-2xl border border-[#333333]/20 bg-white p-6 shadow-lg">
      ...
      <div className="mt-6 space-y-5">
        {feedback ? (
          <p
            className={`rounded-xl border px-4 py-3 text-sm ${feedback.tone === "success"
              ...
              return (
                ...
                >
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    ...
                    <span
                      className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-medium ${admin.isSuperAdmin
